...
public class PriorityNE {
	// Find how many users user 'Garythetwit' has referenced 
    //Outedge Privacy+TO Bound outdegree of nodes- Giving priority to name and emotions to be at the begining of the order. Tweeted has more priority
	public static void main(String[] args) {
		System.out.println("PriorityNE");
		Graph myG = new Graph("tweets.rdf");

		// Priority to tweeted and references
		BoundedOutDegree mBG = new BoundedOutDegree(myG, new Priority2Labels("http://rdfanon.org/types#name","http://rdfanon.org/types#emotion"),Integer.parseInt(args[0]));
