...
public class ALphTR {
    ...
    //QOutedge Privacy+TQL Bound- Ql={tweeted, ref}- OrderAlph
	public static void main(String[] args) {
		System.out.println("AlphTR");
		Graph myG = new Graph("tweets.rdf");

		// according to the lexicographical order
		BoundedTR mBG = new BoundedTR(myG, new OrderAlphabeticalOrderS(), Integer.parseInt(args[0]));
