...
import ordering.Priority2Labels;
import pro2.BoundedOutDegree;
import pro2.Edge;
import pro2.Graph;

public class PriorityTRU {
	// Find how many users user 'Garythetwit' has referenced 
    //Outedge Privacy+TO Bound outdegree of nodes- Giving priority to tweeted and references to be at the begining of the order. Tweeted has more priority
	public static void main(String[] args) {
		System.out.println("PriorityTRU");
		Graph myG = new Graph("tweets.rdf");

		// Priority to tweeted and references
		BoundedOutDegree mBG = new BoundedOutDegree(myG, new Priority2Labels("http://rdfanon.org/types#tweeted","http://rdfanon.org/types#references"), Integer.parseInt(args[0]));
