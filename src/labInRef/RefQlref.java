...
public class RefQlref {
	/*QLOutedge privacy+TQL- Ql=Ref. Order doesn't matter here. take Order ALph
	 Label Specific Indegree Distribution [references]on projected graph*/
	public static void main(String[] args) {
		
		System.out.println("RefQLref");
