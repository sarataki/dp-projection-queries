...
public class PriorityRefQL {
	//Max Ref Outdegree
  //QLOutedge Privacy+TQL Bound QLoutdegree of nodes- QL={timestamp,emotion, text, references }-Giving priority to references to be inserted first

	public static void main(String[] args) {
		System.out.println("PriorityRefQL");
		...
		BoundedQlOutDegree mBG = new BoundedQlOutDegree(myG, new PriorityLabel("http://rdfanon.org/types#references"), Integer.parseInt(args[0]),labels);
