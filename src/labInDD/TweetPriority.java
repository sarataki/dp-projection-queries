...
public class TweetPriority {
	/* Outedge Privacy+ TO- Order: Priority Label i.e give priority to tweeted to be at the beginning of the ordering list
	 label Specific Indegree Distribution [tweeted]on projected graph */
	
	public static void main(String[] args) {
		
		System.out.println("TweetPriority");
