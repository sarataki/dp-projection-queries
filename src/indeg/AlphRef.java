...
public class AlphRef {
	 /* Compute Indegree distribution after projection
	 * QlOutedgePrivacy+ TQL- Order According to LexicographicalOrder+ Ql=references*/

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		System.out.println("QL AlphRef");
		...
		BoundedReferences mBG = new BoundedReferences(myG, new OrderAlphabeticalOrderS(), Integer.parseInt(args[0]));
		...
		try {
			...
			System.out.println("***********************");
			System.out.println("InDegree Distribution: Indegree---Count---Noise Count");
