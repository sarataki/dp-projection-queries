...
import pro2.BoundedReferences;
import pro2.Edge;
import pro2.Graph;

public class MaxOutRef {
  /* QLOutedgePrivacy+ TQL (BoundQLOutdegree)- QL=references  Compute maxOutdegree of nodes. */
	public static void main(String[] args) {
		System.out.println("MaxOutDegree- MaxOutRef");
		...
		BoundedReferences mBG = new BoundedReferences(myG, new OrderLexicographical(), Integer.parseInt(args[0]));
		...
		try {
			...
			System.out.println("QlOutdegree bound=" + args[0] + "  " + "epsilons=" + "  " + args[1] + "  " + args[2]
