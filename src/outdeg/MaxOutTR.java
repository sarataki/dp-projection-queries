...
public class MaxOutTR {
	/* QLOutedgePrivacy+ TQL (BoundQLOutdegree)- QL=references and tweeted- Compute maxOutdegree of nodes. */
	public static void main(String[] args) {
		System.out.println("MaxOutDegree in the graph");
		...
		try {
			...
			for (; results.hasNext();) {
				...
				for (int j = 1; j < 7; j++) {
					for (int i = 0; i < 100; i++) {
						LaplaceNoise l = new LaplaceNoise(gs / Double.parseDouble(args[j]));
