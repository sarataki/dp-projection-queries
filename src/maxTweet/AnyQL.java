...
public class AnyQL {
	//Max tweet Outdegree
  //QLOutedge Privacy+TQL Bound QLoutdegree of nodes- QL={tweeted}-Any Order here choose OrderAlph
	public static void main(String[] args) {
		System.out.println("AnyQL");
		Graph myG = new Graph("tweets.rdf");
		System.out.println("UNBOUNDED EDGES");

		BoundedTweeted mBG = new BoundedTweeted(myG, new OrderAlphabeticalOrderS(), Integer.parseInt(args[0]));
