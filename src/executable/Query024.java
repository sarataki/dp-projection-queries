...
public class Query024 {
	//Label Specific OutDegree Distribution-[references]
	...
	public static void main(String[] args) {
		...
		// TODO Auto-generated method stub
				...
				//compute outdegree
				String queryString=" Select ?outdegree (count(*) as ?count) WHERE{ SELECT ?s  (count(*) as ?outdegree) WHERE{ ?s <http://rdfanon.org/types#references> ?o}Group By ?s ORDER BY DESC(?outdegree)} Group By ?outdegree ORDER BY (?outdegree)";	
