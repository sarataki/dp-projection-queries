...
public class Query011 {
	//What is the sentiment of person x (MamiYessi) towards a specific query term(mcdonalds).
	...
	public static void main(String[] args) {
		...
		//****************** READ FILE **********************
				...
				String queryString1 = "SELECT ?emotion (Count(?tweet) As ?ctweet ) WHERE { <http://rdfanon.org/types#MamiYessi> <http://rdfanon.org/types#tweeted> ?tweet. ?tweet <http://rdfanon.org/types#emotion> ?emotion.  ?tweet <http://rdfanon.org/types#queryterm> 'mcdonalds' }Group By ?emotion";	
		       ...
		       //what is the sentiment of the tweets of a specific person
		        ...
		        System.out.println("The sentiment of the tweets of this  person towards specific query term is");
